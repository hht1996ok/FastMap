...
class MapTRDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False, use_res=False, **kwargs):
    ...
    def forward(self,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            if reg_branches is not None and self.use_res:
                tmp = reg_branches[lid + 1](output)
...
@TRANSFORMER_LAYER.register_module()
class CustomDetrTransformerDecoderLayer(CustomBaseTransformerLayer):
